...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'bookLink'=>[
            'regex'=>'لینک گروه فقط باید حاوی حروف انگلیسی، اعداد و خط فاصله باشد، بدون فضای خالی',
        ],
        'lessonLink'=>[
            'regex'=>'لینک درس فقط باید حاوی حروف انگلیسی، اعداد و خط فاصله باشد، بدون فضای خالی',
        ],
        'wordLink'=>[
        ...
        'lesson_id'=>[
            'required'=>'ابتدا گروه و درس را انتخاب کنید',
        ],
        'word_id'=>[
            'required'=>'ابتدا گروه،درس و کلمه را انتخاب کنید',
        ]
    ],
    ...
    */
    ...
    'attributes' => [
      ...
      'lesson' => 'درس',
      'lessonLink' =>'لینک درس',
      'lesson_section' => 'تیتر درس',
      'lessonSection' => 'تیتر درس',
      'word'=>'کلمه',
      'wordLink'=>'لینک کلمه',
      'sentence'=>'جمله',
